...
extension UIColor {
    ...
    class func appPurpleThemeColor() -> UIColor{
        return UIColor().convertHexStringToColor(hexString: "7e3470")
    }
    
    class func appNavBarColor() -> UIColor {
        return UIColor().convertHexStringToColor(hexString: "cd2145")
    }
    
    class func heartZonesLoadingViewColor() -> UIColor{
        return UIColor().convertHexStringToColor(hexString: "2f2e2e")
    }
    
    class func optionBackgroundColor() -> UIColor {
        return UIColor().convertHexStringToColor(hexString: "fafafa")
    }
    
    class func correctOptionGreenColor() -> UIColor {
        return UIColor().convertHexStringToColor(hexString: "63a163")
    }
    
    class func wrongOptionRedColor() -> UIColor {
        return UIColor().convertHexStringToColor(hexString: "d40000")
    }
